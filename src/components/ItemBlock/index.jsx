  ...
  return (
    <div className={style.root}>
        ...
        <div className={style.rootPicture}>
          <div className={style.rootPictureBtns}>
            <button
              ...
              className={isFavorite ? style.rootPictureBtnsLikeActive : style.rootPictureBtnsLike}>
              <svg viewBox="0 0 24 24" width="30px" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={style.rootSizes}>
        {list.map((e, i) => (
          <button onClick={() => onClickAddSizeItem(i)} key={i} className={style.rootSizesBtn}>
            {e}
          </button>
        ))}
      </div>
